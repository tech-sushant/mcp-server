...
export function runBstackSDKOnly(
  ...
  if (
    ...
    // Add guardrail step asking if user wants Percy setup
    steps.push({
      type: "instruction",
      title: "Optional: Percy Visual Testing Setup",
      content:
        "If you want to add Percy visual testing to your BrowserStack Automate tests, you can use the setupPercyVisualTesting tool with detectedIntegrationType: 'automate_already_setup' since BrowserStack Automate is now configured.",
    });
